...
with artm.library.MasterComponent() as master:
    ...
    top_tokens_score_config.dictionary_name = dictionary.name()
    top_tokens_score_config.count_coherency = True
    ...
    topic_kernel_score_config.dictionary_name = dictionary.name()
    topic_kernel_score_config.count_coherency = True
    ...
    model.EnableRegularizer(improve_coherency, 2)
