...
#ifndef SRC_ARTM_REGULARIZER_SANDBOX_SPECIFIED_SPARSE_PHI_H_
#define SRC_ARTM_REGULARIZER_SANDBOX_SPECIFIED_SPARSE_PHI_H_
...
#endif  // SRC_ARTM_REGULARIZER_SANDBOX_SPECIFIED_SPARSE_PHI_H_
