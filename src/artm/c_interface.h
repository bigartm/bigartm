...
extern "C" {
  ...
  DLL_PUBLIC int ArtmGatherDictionary(int length, const char* gather_dictionary_args);
  DLL_PUBLIC int ArtmFilterDictionary(int length, const char* filter_dictionary_args);
