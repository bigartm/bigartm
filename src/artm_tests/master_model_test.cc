...
void runBasicTest(bool skip_batch_dict) {
  ...
  score_config2->set_type(::artm::ScoreType::SparsityPhi);
  ...
  reg_theta->set_type(::artm::RegularizerType::SmoothSparseTheta);
  ...
  reg_phi->set_type(::artm::RegularizerType::SmoothSparsePhi);
  reg_phi->set_tau(-0.1);
