...
class ARTM(object):
    ...
    def gather_dictionary(self, dictionary_target_name=None, data_path=None, cooc_file_path=None,
        ...
        Args:
          ...
          symmetric_cooc_values (bool): if the cooc matrix should
    ...
    def get_theta(self, topic_names=None, remove_theta=False):
        ...
        Returns:
          ...
          * **columns** --- the ids of documents, for which the Theta
            matrix was requested
          * **rows** --- the names of topics in topic model, that was
