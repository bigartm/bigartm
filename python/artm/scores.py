...
class BaseScore(object):
    ...
    def __init__(self, name, class_id, transaction_typename, topic_names, model_name, config):
...
class SparsityPhiScore(BaseScore):
    ...
    def __init__(self, name=None, class_id=None, transaction_typename=None,
        ...
        :param str transaction_typename: transaction_typename to score
        ...
        BaseScore.__init__(self,
                           name=name,
                           class_id=class_id,
                           transaction_typename=transaction_typename,
                           topic_names=topic_names,
...
class SparsityThetaScore(BaseScore):
    ...
    @property
    def transaction_typename(self):
        raise KeyError('No transaction_typename parameter')
...
class PerplexityScore(BaseScore):
    ...
    def __init__(self, name=None, class_ids=None, transaction_typenames=None, dictionary=None, config=None):
        """
        :param str name: the identifier of score, will be auto-generated if not specified
        :param class_ids: class_ids to score, None means that tokens of all class_ids will be used
        :type class_ids: list of str
        :param transaction_typenames: transaction_typenames to score, None means that tokens of all\
                                  model transaction_typenames will be used. In case of non-transaction models this\
...
class TopicKernelScore(BaseScore):
    ...
    def __init__(self, name=None, class_id=None, transaction_typename=None, topic_names=None, eps=None,
...
class TopicMassPhiScore(BaseScore):
    ...
    def __init__(self, name=None, class_ids=None, transaction_typenames=None,
                 topic_names=None, model_name=None, eps=None, config=None):
        """
        :param str name: the identifier of score, will be auto-generated if not specified
        :param class_ids: class_id to score, means that tokens of all class_ids will be used
        :type class_ids: list of str
        :param transaction_typenames: transaction types to score, None means that tokens of all\
...
class BackgroundTokensRatioScore(BaseScore):
    ...
    def __init__(self, name=None, class_id=None, transaction_typename=None, delta_threshold=None,
